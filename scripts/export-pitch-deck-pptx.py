...
We ship this as two repos today — appliance plus GTM — with one customer promise.""",
    ...
    (
        ...
        [
            "curxor-os — appliance: /opt/curxor/, systemd, OTA · v0.1.0 · 14/14 QA",
...
• v0.1.0 stable, CI green, fourteen API smoke tests passing.
...
What is actually shipped today vs what is gated on hardware.""",
    ...
    (
        ...
        [
            ...
            "",
            "v0.1.0 · QA smoke 14/14 · Pre-order live",
        ],
...
METRICS ON SLIDE
v0.1.0 · 14/14 QA smoke · pre-order live — say each number out loud.
...
Here is how we close the hardware gate and scale.""",
    ...
    (
        "Roadmap",
        [
            "Now (v0.1.0): scaffold · GTM live · CI green · QA smoke",
