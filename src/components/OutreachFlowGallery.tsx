...
import { outreachFlowShots } from "@/lib/outreach-page";

export function OutreachFlowGallery() {
  return (
    <section id="outreach-flows" className="relative border-t border-white/10 py-24">
