...
export const changelogEntries = [
  {
    ...
    highlights: [
      "CurXor OS 0.1.0 — Flight Command dashboard with Home hub and eight bundled Claw verticals",
      "Simple/Expert UI modes, grouped Claw navigation, and chat workspaces with skill buttons",
      ...
      "Storefront pre-order at curxor.ai — $3,999 once, $0/mo API",
    ],
  },
] as const;
