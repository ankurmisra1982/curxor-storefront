...
export const comparePages: ComparePage[] = [
  ...
  },
  {
    ...
    whoShouldBuyCurxor:
      "Choose CurXor if you want turnkey crewmates, 64GB local models, eno2 egress isolation, and zero CurXor subscription fees.",
    rows: [
      ...
      { label: "Wealth / trading", them: "General automation", curxor: "Capital · Alpaca bridge on eno2" },
      { label: "Creator pipeline", them: "General Mac workflows", curxor: "Creator · multi-platform publish bridges" },
  ...
  },
  {
    ...
    lead: "A Mac Studio with Ollama is excellent inference hardware — if you enjoy building the agent stack yourself. CurXor bundles CurXor OS, Flight Command, crewmates, and bridges on MS-S1 MAX class silicon — with an OTA channel on the roadmap.",
    ...
    rows: [
      ...
      { label: "Time to first crewmate", them: "Days to weeks", curxor: "Same session · Settings → enable desk crew" },
    ],
  },
  {
    slug: "nemoclaw",
