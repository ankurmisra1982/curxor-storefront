...
export const dreamStateInvestorParagraph =
  "CurXor is a sovereign AI system — not a chat app, not a cloud subscription. Custom desk hardware runs CurXor OS, a full vertical stack built for local inference, autonomous agents, and operator control from the metal up. Flagship Claws are your digital employees day one — capital, creation, outreach — with The Forge to mint more and honest previews for the rest of the roster. Coordinated through Flight Command and the Claw Cafe. Outbound action crosses a physical egress boundary you control; cognition stays local by default. Today we prove the stack on MS-S1-class metal. After investment, we ship CurXor-designed hardware. The long-term destination is a fully sovereign OS — no Linux dependency, no rented intelligence — so your AI team isn't a feature on someone else's platform. It's yours, from silicon to Claw.";
