...
export const journalEssays: JournalEntry[] = [
  {
    ...
    relatedLinks: [
      ...
      { href: "/demo/hero-category-badge-v8.2.mp4", label: "Category vision (~103s)" },
    ...
    body: [
      ...
      {
        type: "p",
        text: "The category vision film is live on /signal — about one hundred and three seconds of desk crew, always-on life, the approval gate, and how the desk gets richer as you evolve. A shorter version (~62s) is there if you want the faster watch. Product proof (~89s) is the second tab: Capital, Creator, and Outreach captured on real MS-S1 metal.",
      },
      {
        type: "p",
