...
export const personaPages: PersonaPage[] = [
  {
    ...
    metaDescription:
      "Capital on sovereign hardware — local inference, Alpaca bridge on eno2, alpha that stays on your metal.",
    eyebrow: "FOR TRADERS",
    headline: "Your alpha stays on bare metal.",
    lead: "Capital demo tour day one — rules, simulated fills, Go Live without broker keys.",
    painPoints: [
    ...
    compareLinks: [
      { href: "/capital", label: "Capital tour" },
  ...
  },
  {
    ...
    compareLinks: [
      { href: "/creator", label: "Creator tour" },
  ...
  },
  {
    ...
    metaDescription:
      "Outreach — demo tour, sequences, CSV import, A/B subjects, reply intent, and send policy on sovereign hardware.",
    eyebrow: "FOR AGENCIES",
    headline: "Pipeline to send — one desk.",
    lead: "Outreach demo tour — demo lead, A/B sequence, simulated send. CSV import and reply intent when you scale.",
    painPoints: [
    ...
    claws: [
      ...
      {
        name: "The Forge",
        body: "White-label a vertical crewmate for a client niche.",
      },
    ],
    demoSrc: "/demo/outreach/21-pipeline.png",
    demoAlt: "Outreach desk — Go Live, pipeline, sequences",
    outcomes: [
      "Demo tour to simulated send — no SMTP on day one",
      "eno2 unplug stops outbound while inference continues",
    ],
    compareLinks: [
      { href: "/outreach", label: "Outreach tour" },
