...
export const signalTodayTabs = [
  {
    tab: "Home",
    body: "Neural link readiness · setup journey · relationship tone",
  },
  {
    tab: "Fleet",
    body: "Multi-unit registry · pair-day wizard (preview)",
  },
  {
    tab: "Knowledge",
    body: "Kin-aware house rules · push context to robot memory",
  },
  {
    tab: "Routines",
    body: "Instruction templates · NL compose · armed for pair day",
  },
  {
    tab: "Control",
    body: "Motor mesh preview — live motion hardware-gated",
  },
] as const;
